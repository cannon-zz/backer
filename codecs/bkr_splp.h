...
#define BKR_SPLPENC_CLASS(klass)	(G_TYPE_CHECK_CLASS_CAST((klass), BKR_SPLPENC_TYPE, BkrSPLPEncClass))
...
#define BKR_SPLPDEC_CLASS(klass)	(G_TYPE_CHECK_CLASS_CAST((klass), BKR_SPLPDEC_TYPE, BkrSPLPDecClass))
