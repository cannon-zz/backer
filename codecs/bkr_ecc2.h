...
#define BKR_ECC2ENC_CLASS(klass)	(G_TYPE_CHECK_CLASS_CAST((klass), BKR_ECC2ENC_TYPE, BkrECC2EncClass))
...
#define BKR_ECC2DEC_CLASS(klass)	(G_TYPE_CHECK_CLASS_CAST((klass), BKR_ECC2DEC_TYPE, BkrECC2DecClass))
